...
namespace Ungu_CV1
{
    ...
    public partial class Form1 : Form
    {
        ...
        int minNeighbors = 3; //Minimum number (minus 1) of neighbor rectangles that makes up an object. All the groups of a smaller number of rectangles than min_neighbors-1 are rejected. If min_neighbors is 0, the function does not any grouping at all and returns all the detected candidate rectangles, which may be useful if the user wants to apply a customized grouping procedure
        ...
        public Form1()
        {
            ...
            HasCuda = Convert.ToBoolean(appSettings["HasCuda"] ?? "false");
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                catch (Exception errHasCuda)
                {
                    Debug.WriteLine("ERROR on HasCuda, no it doesn't startup = " + errHasCuda + " hasCuda=" + HasCuda);
                }
        ...
        void capturePicture()
        {
            ...
            catch (Exception errend)
            {
                Console.WriteLine("ERROR capturePicture apWebcam.QueryFrame()" + errend);
                return; 
            }
            if (imgOriginal == null || imgOriginal.Size == null || imgOriginal.Size.Width == 0) return;
        ...
        {
            String imageFileName = listBoxVideos.SelectedItem == null ? null : listBoxVideos.SelectedItem.ToString() ;
            Debug.WriteLine("listBoxVideos_SelectedIndexChanged=" + imageFileName + sender + e);
            try
            {
                if (imageFileName != null && imageFileName != "" && imageFileName != "videos\\README.txt")
